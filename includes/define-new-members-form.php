...
$confirmation_template = $PLUGIN_DIR . 'templates/new-member-confirmation.php';
...
{
		global $new_member_page_title; $new_member_confirmation_title;
		$form_page = get_page_by_title($new_member_form_title);
		$confirmation_page = get_page_by_title($new_member_confirmation_title);
		wp_delete_post($form_page->ID);
		wp_delete_post($confirmation_page->ID);
}
